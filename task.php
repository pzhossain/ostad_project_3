...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Task addition (checking provided tasks, add it to the tasks array then save)
    if(isset($_POST['task']) && !empty(trim($_POST['task']))){ 
        ...
        // Task deletion (if requesting a delete action, then remove that task from array, then save)
        // delete a task
        ...
        // Task completion toggle (if requesting a toggle action then update task's done status, and save)
